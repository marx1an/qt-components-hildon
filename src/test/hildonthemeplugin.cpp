...
HildonThemePlugin::HildonThemePlugin(QDeclarativeItem *parent) :
    QObject(parent),
    m_theme(new QSettings("/home/stuart/Development/QtProjects/Maemo5_Theme/colors.config", QSettings::IniFormat, this)),
    m_transitions(0),
    m_enableDesaturationEffects(false)
{
    ...
    QFileInfo info("/home/stuart/Development/QtProjects/Maemo5_Theme/transitions.ini");
